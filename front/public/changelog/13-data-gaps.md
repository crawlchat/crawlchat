...
Depending on the scores for above two features, it decides if there is any potentials data gap. If so, it _drafts_ a note explaining the topic of the data gap and points to cover.
