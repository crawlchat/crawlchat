...
![Linear group](/changelog-images/linear-group.png)

- **Log in** to your Linear account
- Navigate to **Settings** > **Security & access**
- Click **New token** under **Personal API keys**
- Name your key (e.g., _CrawlChat_) and select _Only select permissions_
- Tick the _Read_ box and choose _All teams_ you can access
- Click **Create** and copy your **API Key**
- Head to the [New Group](https://crawlchat.app/knowledge/group) page to import your Linear issues into CrawlChat, providing the API token you generated
