...
| `customTags` (optional) | `Json`   | Any custom information that will be set on the ticket and will be shown on the dashboard. The value should be on of `string`, `number` or `boolean` types |
